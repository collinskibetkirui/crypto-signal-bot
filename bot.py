...
TEXTS = {
    'en': {
        ...
        'confirm_plan': "📌 You selected *{plan}* for *${price}*.\n\nDo you want to proceed?",
    ...
    'es': {
        ...
        'confirm_plan': "📌 Has seleccionado *{plan}* por *${price}*.\n\n¿Deseas continuar?",
    ...
    'ru': {
        ...
        'confirm_plan': "📌 Вы выбрали *{plan}* за *${price}*.\n\nПродолжить?",
        ...
        'history_title': "📜 *ИСТОРИЯ ПЛАТЕЖЕЙ*\n\nВаши прошлые транзакции:",
        'no_history': "📭 *История платежей не найдена.*\n\nНажмите *КУПИТЬ VIP*, чтобы совершить первую покупку.",
        'history_entry': "┌──────────────────\n📅 *Дата:* {date}\n📌 *План:* {plan}\n💰 *Сумма:* ${amount}\n💳 *Метод:* {method}\n└── *Статус:* {status}\n",
    ...
    'ar': {
        ...
        'confirm_plan': "📌 لقد اخترت *{plan}* مقابل *${price}*.\n\nهل تريد المتابعة؟",
        ...
        'no_history': "📭 *لا يوجد سجل مدفوعات.*\n\nانقر *شراء VIP* لإجراء أول عملية شراء.",
        'history_entry': "┌──────────────────\n📅 *التاريخ:* {date}\n📌 *الخطة:* {plan}\n💰 *المبلغ:* ${amount}\n💳 *الطريقة:* {method}\n└── *الحالة:* {status}\n",
...
async def show_languages(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    reply_markup = InlineKeyboardMarkup(keyboard)
    await query.edit_message_text("🌐 *Select your language*", reply_markup=reply_markup, parse_mode="Markdown")
...
def main():
    print("=" * 50)
    print("✨ Starting Crypto Signal Bot (Linear Flow) ✨")
